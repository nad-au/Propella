...
namespace Domain.Api.V1.Client.Api
{
    ...
    public partial class StatisticsApi : IStatisticsApi
    {
        ...
        /// <returns></returns>
        public StatisticsApi(Domain.Api.V1.Client.Client.Configuration configuration)
        {
        ...
        public StatisticsApi(Domain.Api.V1.Client.Client.ISynchronousClient client, Domain.Api.V1.Client.Client.IAsynchronousClient asyncClient, Domain.Api.V1.Client.Client.IReadableConfiguration configuration)
        {
        ...
        /// <param name="body">A JSON object dictionary of the metadata associated with the event.</param>
        /// <returns>ApiResponse of Object(void)</returns>
        public Domain.Api.V1.Client.Client.ApiResponse<Object> StatisticsPostWithHttpInfo(string _event, Object body)
        {
            // verify the required parameter '_event' is set
            if (_event == null)
                throw new Domain.Api.V1.Client.Client.ApiException(400, "Missing required parameter '_event' when calling StatisticsApi->StatisticsPost");

            // verify the required parameter 'body' is set
            if (body == null)
                throw new Domain.Api.V1.Client.Client.ApiException(400, "Missing required parameter 'body' when calling StatisticsApi->StatisticsPost");
            ...
            localVarRequestOptions.PathParameters.Add("event", Domain.Api.V1.Client.Client.ClientUtils.ParameterToString(_event)); // path parameter
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.Client.ApiResponse<Object>> StatisticsPostWithHttpInfoAsync(string _event, Object body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter '_event' is set
            if (_event == null)
                throw new Domain.Api.V1.Client.Client.ApiException(400, "Missing required parameter '_event' when calling StatisticsApi->StatisticsPost");
