...
namespace Domain.Api.V1.Api
{
    ...
    public partial class DemographicsApi : IDemographicsApi
    {
        ...
        /// <returns></returns>
        public DemographicsApi(Domain.Api.V1.Client.Configuration configuration)
        {
        ...
        public DemographicsApi(Domain.Api.V1.Client.ISynchronousClient client, Domain.Api.V1.Client.IAsynchronousClient asyncClient, Domain.Api.V1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainDemographicsServiceV1ModelDemographicsResultsModel> localVarResponse = DemographicsGetWithHttpInfo(level, id, types, year);
        ...
        /// <param name="year">Year of the source data.  Valid values are: &#x60;2011&#x60;, &#x60;2016&#x60; (optional)</param>
        /// <returns>ApiResponse of DomainDemographicsServiceV1ModelDemographicsResultsModel</returns>
        public Domain.Api.V1.Client.ApiResponse<DomainDemographicsServiceV1ModelDemographicsResultsModel> DemographicsGetWithHttpInfo(string level, int id, string types = default(string), string year = default(string))
        {
            // verify the required parameter 'level' is set
            if (level == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'level' when calling DemographicsApi->DemographicsGet");
            ...
            localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "level", level));
            localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "id", id));
            if (types != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "types", types));
            }
            if (year != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "year", year));
            }
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainDemographicsServiceV1ModelDemographicsResultsModel> localVarResponse = await DemographicsGetWithHttpInfoAsync(level, id, types, year, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainDemographicsServiceV1ModelDemographicsResultsModel)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<DomainDemographicsServiceV1ModelDemographicsResultsModel>> DemographicsGetWithHttpInfoAsync(string level, int id, string types = default(string), string year = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'level' is set
            if (level == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'level' when calling DemographicsApi->DemographicsGet");
