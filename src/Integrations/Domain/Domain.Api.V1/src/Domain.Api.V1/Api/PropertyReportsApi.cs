...
namespace Domain.Api.V1.Api
{
    ...
    public partial class PropertyReportsApi : IPropertyReportsApi
    {
        ...
        /// <returns></returns>
        public PropertyReportsApi(Domain.Api.V1.Client.Configuration configuration)
        {
        ...
        public PropertyReportsApi(Domain.Api.V1.Client.ISynchronousClient client, Domain.Api.V1.Client.IAsynchronousClient asyncClient, Domain.Api.V1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainPropertyReportServiceV1ModelPropertyReportGenerationResult> localVarResponse = PropertyReportsGetWithHttpInfo(propertyType, streetNumber, streetName, suburb, state, unitNumber, streetType, postcode, areaSize, bedrooms, bathrooms, parking, preparedFor, productCode);
        ...
        /// <param name="productCode">Report product code (optional)</param>
        /// <returns>ApiResponse of DomainPropertyReportServiceV1ModelPropertyReportGenerationResult</returns>
        public Domain.Api.V1.Client.ApiResponse<DomainPropertyReportServiceV1ModelPropertyReportGenerationResult> PropertyReportsGetWithHttpInfo(string propertyType, string streetNumber, string streetName, string suburb, string state, string unitNumber = default(string), string streetType = default(string), string postcode = default(string), int? areaSize = default(int?), int? bedrooms = default(int?), int? bathrooms = default(int?), int? parking = default(int?), string preparedFor = default(string), string productCode = default(string))
        {
            // verify the required parameter 'propertyType' is set
            if (propertyType == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'propertyType' when calling PropertyReportsApi->PropertyReportsGet");

            // verify the required parameter 'streetNumber' is set
            if (streetNumber == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'streetNumber' when calling PropertyReportsApi->PropertyReportsGet");

            // verify the required parameter 'streetName' is set
            if (streetName == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'streetName' when calling PropertyReportsApi->PropertyReportsGet");

            // verify the required parameter 'suburb' is set
            if (suburb == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'suburb' when calling PropertyReportsApi->PropertyReportsGet");

            // verify the required parameter 'state' is set
            if (state == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'state' when calling PropertyReportsApi->PropertyReportsGet");
            ...
            localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "propertyType", propertyType));
            ...
            if (areaSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "areaSize", areaSize));
            }
            if (bedrooms != null)
            {
            ...
            if (bathrooms != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "bathrooms", bathrooms));
            }
            if (parking != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "parking", parking));
            }
            if (preparedFor != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "preparedFor", preparedFor));
            }
            if (productCode != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "productCode", productCode));
            }
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainPropertyReportServiceV1ModelPropertyReportGenerationResult> localVarResponse = await PropertyReportsGetWithHttpInfoAsync(propertyType, streetNumber, streetName, suburb, state, unitNumber, streetType, postcode, areaSize, bedrooms, bathrooms, parking, preparedFor, productCode, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainPropertyReportServiceV1ModelPropertyReportGenerationResult)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<DomainPropertyReportServiceV1ModelPropertyReportGenerationResult>> PropertyReportsGetWithHttpInfoAsync(string propertyType, string streetNumber, string streetName, string suburb, string state, string unitNumber = default(string), string streetType = default(string), string postcode = default(string), int? areaSize = default(int?), int? bedrooms = default(int?), int? bathrooms = default(int?), int? parking = default(int?), string preparedFor = default(string), string productCode = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'propertyType' is set
            if (propertyType == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'propertyType' when calling PropertyReportsApi->PropertyReportsGet");
