...
namespace Domain.Api.V1.Api
{
    ...
    public partial class SalesResultsApi : ISalesResultsApi
    {
        ...
        /// <returns></returns>
        public SalesResultsApi(Domain.Api.V1.Client.Configuration configuration)
        {
        ...
        public SalesResultsApi(Domain.Api.V1.Client.ISynchronousClient client, Domain.Api.V1.Client.IAsynchronousClient asyncClient, Domain.Api.V1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsSummary> localVarResponse = SalesResultsGetWithHttpInfo(city);
        ...
        /// <param name="city">City. Supported cities are: &#x60;Sydney&#x60;, &#x60;Melbourne&#x60;, &#x60;Brisbane&#x60;, &#x60;Adelaide&#x60;, &#x60;Canberra&#x60;</param>
        /// <returns>ApiResponse of DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsSummary</returns>
        public Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsSummary> SalesResultsGetWithHttpInfo(string city)
        {
            // verify the required parameter 'city' is set
            if (city == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'city' when calling SalesResultsApi->SalesResultsGet");
            ...
            localVarRequestOptions.PathParameters.Add("city", Domain.Api.V1.Client.ClientUtils.ParameterToString(city)); // path parameter
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsSummary> localVarResponse = await SalesResultsGetWithHttpInfoAsync(city, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsSummary)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsSummary>> SalesResultsGetWithHttpInfoAsync(string city, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'city' is set
            if (city == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'city' when calling SalesResultsApi->SalesResultsGet");
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsDate> localVarResponse = SalesResultsHeadWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <exception cref="Domain.Api.V1.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsDate</returns>
        public Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsDate> SalesResultsHeadWithHttpInfo()
        {
            Domain.Api.V1.Client.RequestOptions localVarRequestOptions = new Domain.Api.V1.Client.RequestOptions();
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsDate> localVarResponse = await SalesResultsHeadWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsDate)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<DomainSalesResultsServiceV1ModelDomainSalesResultsModelCityResultsDate>> SalesResultsHeadWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1SalesResultsListingSummary>> localVarResponse = SalesResultsListingsWithHttpInfo(city);
            return localVarResponse.Data;
        }
        ...
        /// <param name="city">City. Supported cities are: &#x60;Sydney&#x60;, &#x60;Melbourne&#x60;, &#x60;Brisbane&#x60;, &#x60;Adelaide&#x60;, &#x60;Canberra&#x60;</param>
        /// <returns>ApiResponse of List&lt;DomainPublicAdapterWebApiModelsV1SalesResultsListingSummary&gt;</returns>
        public Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1SalesResultsListingSummary>> SalesResultsListingsWithHttpInfo(string city)
        {
            // verify the required parameter 'city' is set
            if (city == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'city' when calling SalesResultsApi->SalesResultsListings");
        ...
        {
            Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1SalesResultsListingSummary>> localVarResponse = await SalesResultsListingsWithHttpInfoAsync(city, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;DomainPublicAdapterWebApiModelsV1SalesResultsListingSummary&gt;)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1SalesResultsListingSummary>>> SalesResultsListingsWithHttpInfoAsync(string city, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'city' is set
            if (city == null)
                throw new Domain.Api.V1.Client.ApiException(400, "Missing required parameter 'city' when calling SalesResultsApi->SalesResultsListings");
