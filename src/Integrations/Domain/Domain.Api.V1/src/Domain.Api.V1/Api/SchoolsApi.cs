...
namespace Domain.Api.V1.Api
{
    ...
    public partial class SchoolsApi : ISchoolsApi
    {
        ...
        /// <returns></returns>
        public SchoolsApi(Domain.Api.V1.Client.Configuration configuration)
        {
        ...
        public SchoolsApi(Domain.Api.V1.Client.ISynchronousClient client, Domain.Api.V1.Client.IAsynchronousClient asyncClient, Domain.Api.V1.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool> localVarResponse = SchoolsGetWithHttpInfo(id);
        ...
        /// <param name="id">School identifier</param>
        /// <returns>ApiResponse of DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool</returns>
        public Domain.Api.V1.Client.ApiResponse<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool> SchoolsGetWithHttpInfo(int id)
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool> localVarResponse = await SchoolsGetWithHttpInfoAsync(id, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool>> SchoolsGetWithHttpInfoAsync(int id, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        {
            Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool>> localVarResponse = SchoolsSearchWithHttpInfo(coordinate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="coordinate">Filter schools to include the specified coordinate in their catchment area (lat,long) (optional)</param>
        /// <returns>ApiResponse of List&lt;DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool&gt;</returns>
        public Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool>> SchoolsSearchWithHttpInfo(string coordinate = default(string))
        {
            Domain.Api.V1.Client.RequestOptions localVarRequestOptions = new Domain.Api.V1.Client.RequestOptions();
            ...
            if (coordinate != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.V1.Client.ClientUtils.ParameterToMultiMap("", "coordinate", coordinate));
            }
        ...
        {
            Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool>> localVarResponse = await SchoolsSearchWithHttpInfoAsync(coordinate, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool&gt;)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.V1.Client.ApiResponse<List<DomainPublicAdapterWebApiModelsV1LocationsSchoolsSchool>>> SchoolsSearchWithHttpInfoAsync(string coordinate = default(string), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
