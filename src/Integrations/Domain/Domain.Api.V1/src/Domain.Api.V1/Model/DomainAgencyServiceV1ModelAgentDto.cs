...
{
    /// <summary>
    /// DomainAgencyServiceV1ModelAgentDto
    /// </summary>
    [DataContract(Name = "Domain.AgencyService.v1.Model.AgentDto")]
    public partial class DomainAgencyServiceV1ModelAgentDto : IEquatable<DomainAgencyServiceV1ModelAgentDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainAgencyServiceV1ModelAgentDto" /> class.
        /// </summary>
        ...
        /// <param name="mugShotURL">mugShotURL.</param>
        ...
        public DomainAgencyServiceV1ModelAgentDto(DateTime dateUpdated = default(DateTime), int agencyId = default(int), int agentId = default(int), string email = default(string), string firstName = default(string), string mobile = default(string), string photo = default(string), string lastName = default(string), string isActiveProfilePage = default(string), string phone = default(string), bool saleActive = default(bool), bool rentalActive = default(bool), string secondaryEmail = default(string), string facebookUrl = default(string), string twitterUrl = default(string), string agentVideo = default(string), string profileText = default(string), bool isHideSoldLeasedListings = default(bool), string googlePlusUrl = default(string), string personalWebsiteUrl = default(string), string linkedInUrl = default(string), string fax = default(string), string mugShotURL = default(string), string mugShotNew = default(string), int contactTypeCode = default(int), bool receivesRequests = default(bool), string creAgentVideoURL = default(string), bool receiveScheduledReportEmail = default(bool), string profileUrl = default(string), string jobPosition = default(string))
        {
        ...
        /// </summary>
        [DataMember(Name = "mugShotURL", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainAgencyServiceV1ModelAgentDto {\n");
        ...
        {
            return this.Equals(input as DomainAgencyServiceV1ModelAgentDto);
        }

        /// <summary>
        /// Returns true if DomainAgencyServiceV1ModelAgentDto instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainAgencyServiceV1ModelAgentDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainAgencyServiceV1ModelAgentDto input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.MugShotURL == input.MugShotURL ||
                    (this.MugShotURL != null &&
                    this.MugShotURL.Equals(input.MugShotURL))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MugShotURL != null)
                    hashCode = hashCode * 59 + this.MugShotURL.GetHashCode();
