...
namespace Domain.Api.V1.Model
{
    ...
    /// Auction Details
    /// </summary>
    [DataContract(Name = "Domain.ListingAdminService.v1.Model.Auction")]
    public partial class DomainListingAdminServiceV1ModelAuction : IEquatable<DomainListingAdminServiceV1ModelAuction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainListingAdminServiceV1ModelAuction" /> class.
        /// </summary>
        ...
        public DomainListingAdminServiceV1ModelAuction(DateTime dateTime = default(DateTime), string location = default(string), string url = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainListingAdminServiceV1ModelAuction {\n");
        ...
        {
            return this.Equals(input as DomainListingAdminServiceV1ModelAuction);
        }

        /// <summary>
        /// Returns true if DomainListingAdminServiceV1ModelAuction instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainListingAdminServiceV1ModelAuction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainListingAdminServiceV1ModelAuction input)
        {
            if (input == null)
                return false;
