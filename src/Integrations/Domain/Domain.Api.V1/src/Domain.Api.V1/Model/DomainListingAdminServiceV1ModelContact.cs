...
namespace Domain.Api.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Domain.ListingAdminService.v1.Model.Contact")]
    public partial class DomainListingAdminServiceV1ModelContact : IEquatable<DomainListingAdminServiceV1ModelContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainListingAdminServiceV1ModelContact" /> class.
        /// </summary>
        ...
        public DomainListingAdminServiceV1ModelContact(int domainAgentId = default(int), string firstName = default(string), string lastName = default(string), string phone = default(string), string fax = default(string), string mobile = default(string), string email = default(string), bool receiveEmails = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainListingAdminServiceV1ModelContact {\n");
        ...
        {
            return this.Equals(input as DomainListingAdminServiceV1ModelContact);
        }

        /// <summary>
        /// Returns true if DomainListingAdminServiceV1ModelContact instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainListingAdminServiceV1ModelContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainListingAdminServiceV1ModelContact input)
        {
            if (input == null)
                return false;
