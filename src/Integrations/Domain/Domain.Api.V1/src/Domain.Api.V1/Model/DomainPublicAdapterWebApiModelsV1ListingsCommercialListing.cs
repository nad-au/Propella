...
namespace Domain.Api.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Domain.Public.Adapter.Web.Api.Models.v1.Listings.Commercial.Listing")]
    public partial class DomainPublicAdapterWebApiModelsV1ListingsCommercialListing : IEquatable<DomainPublicAdapterWebApiModelsV1ListingsCommercialListing>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainPublicAdapterWebApiModelsV1ListingsCommercialListing" /> class.
        /// </summary>
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialListing(DomainPublicAdapterWebApiModelsV1ListingsCommercialAd ad = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialAd), string price = default(string), DomainPublicAdapterWebApiModelsV1ListingsCommercialAdvertiser advertiser = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialAdvertiser), DomainPublicAdapterWebApiModelsV1ListingsCommercialGeoLocation geoLocation = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialGeoLocation), string propertyArea = default(string), string propertyType = default(string), string address = default(string), string headline = default(string), bool hasVideo = default(bool), List<DomainPublicAdapterWebApiModelsV1ListingsCommercialMedia> media = default(List<DomainPublicAdapterWebApiModelsV1ListingsCommercialMedia>), string auctionDate = default(string), int id = default(int), DomainPublicAdapterWebApiModelsV1ListingsCommercialMetadata metadata = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialMetadata), int carspaceCount = default(int))
        {
            this.Ad = ad;
            this.Price = price;
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialAd Ad { get; set; }
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialAdvertiser Advertiser { get; set; }

        /// <summary>
        /// Gets or Sets GeoLocation
        /// </summary>
        [DataMember(Name = "geoLocation", EmitDefaultValue = false)]
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialGeoLocation GeoLocation { get; set; }
        ...
        public List<DomainPublicAdapterWebApiModelsV1ListingsCommercialMedia> Media { get; set; }
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialMetadata Metadata { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainPublicAdapterWebApiModelsV1ListingsCommercialListing {\n");
        ...
        {
            return this.Equals(input as DomainPublicAdapterWebApiModelsV1ListingsCommercialListing);
        }

        /// <summary>
        /// Returns true if DomainPublicAdapterWebApiModelsV1ListingsCommercialListing instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainPublicAdapterWebApiModelsV1ListingsCommercialListing to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainPublicAdapterWebApiModelsV1ListingsCommercialListing input)
        {
            if (input == null)
                return false;
