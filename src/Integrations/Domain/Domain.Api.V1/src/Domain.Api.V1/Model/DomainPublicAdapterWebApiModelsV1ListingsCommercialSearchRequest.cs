...
namespace Domain.Api.V1.Model
{
    ...
    /// </summary>
    [DataContract(Name = "Domain.Public.Adapter.Web.Api.Models.v1.Listings.Commercial.SearchRequest")]
    public partial class DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest : IEquatable<DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public enum SearchModeEnum
        {
            ...
            /// <summary>
            /// Enum ForLease for value: forLease
            /// </summary>
            [EnumMember(Value = "forLease")]
            ForLease = 2,
        ...
        public enum SortEnum
        {
            ...
            /// <summary>
            /// Enum CheapestTotalFirst for value: cheapestTotalFirst
            /// </summary>
            [EnumMember(Value = "cheapestTotalFirst")]
            CheapestTotalFirst = 3,

            /// <summary>
            /// Enum CheapestPerSqmFirst for value: cheapestPerSqmFirst
            /// </summary>
            [EnumMember(Value = "cheapestPerSqmFirst")]
            CheapestPerSqmFirst = 4,

            /// <summary>
            /// Enum MostExpensiveTotalFirst for value: mostExpensiveTotalFirst
            /// </summary>
            [EnumMember(Value = "mostExpensiveTotalFirst")]
            MostExpensiveTotalFirst = 5,

            /// <summary>
            /// Enum MostExpensivePerSqmFirst for value: mostExpensivePerSqmFirst
            /// </summary>
            [EnumMember(Value = "mostExpensivePerSqmFirst")]
            MostExpensivePerSqmFirst = 6,
            ...
            /// <summary>
            /// Enum BuildingSizeAsc for value: buildingSizeAsc
            /// </summary>
            [EnumMember(Value = "buildingSizeAsc")]
            BuildingSizeAsc = 9,

            /// <summary>
            /// Enum BuildingSizeDesc for value: buildingSizeDesc
            /// </summary>
            [EnumMember(Value = "buildingSizeDesc")]
            BuildingSizeDesc = 10
        ...
        {
            /// <summary>
            /// Enum StandardSale for value: standardSale
            /// </summary>
            [EnumMember(Value = "standardSale")]
            StandardSale = 1,
        ...
        public enum PropertyTitleEnum
        {
            ...
            /// <summary>
            /// Enum Strata for value: strata
            /// </summary>
            [EnumMember(Value = "strata")]
            Strata = 2,

            /// <summary>
            /// Enum NoBuilding for value: noBuilding
            /// </summary>
            [EnumMember(Value = "noBuilding")]
            NoBuilding = 3
        ...
        /// </summary>
        /// <value>Property title</value>
        [DataMember(Name = "propertyTitle", EmitDefaultValue = false)]
        public PropertyTitleEnum? PropertyTitle { get; set; }
        /// <summary>
        /// Defines ExclusionTypes
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum ExclusionTypesEnum
        {
            /// <summary>
            /// Enum SurroundingSuburbs for value: surroundingSuburbs
            /// </summary>
            [EnumMember(Value = "surroundingSuburbs")]
            SurroundingSuburbs = 1,

            /// <summary>
            /// Enum WithoutPrice for value: withoutPrice
            /// </summary>
            [EnumMember(Value = "withoutPrice")]
            WithoutPrice = 2
        ...
        /// Exclusion Types
        /// </summary>
        /// <value>Exclusion Types</value>
        [DataMember(Name = "exclusionTypes", EmitDefaultValue = false)]
        public List<ExclusionTypesEnum> ExclusionTypes { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest" /> class.
        /// </summary>
        /// <param name="pageNumber">pageNumber.</param>
        /// <param name="advertiserId">Agency ID.</param>
        ...
        /// <param name="landAreaMin">Minimum land area.</param>
        /// <param name="landAreaMax">Maximum land area.</param>
        /// <param name="buildingSizeMin">Minimum building area.</param>
        /// <param name="buildingSizeMax">Maximum building area.</param>
        ...
        /// <param name="exclusionTypes">Exclusion Types.</param>
        /// <param name="annualReturn">Minimum annual return (in percents).</param>
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest(int pageNumber = default(int), int advertiserId = default(int), int pageSize = default(int), List<PropertyTypesEnum> propertyTypes = default(List<PropertyTypesEnum>), DomainPublicAdapterWebApiModelsV1ListingsCommercialPriceSearch price = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialPriceSearch), List<DomainPublicAdapterWebApiModelsV1ListingsCommercialLocationSearch> locations = default(List<DomainPublicAdapterWebApiModelsV1ListingsCommercialLocationSearch>), List<string> keywords = default(List<string>), DomainPublicAdapterWebApiModelsV1ListingsCommercialGeoWindow geoWindow = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialGeoWindow), int landAreaMin = default(int), int landAreaMax = default(int), int buildingSizeMin = default(int), int buildingSizeMax = default(int), SearchModeEnum? searchMode = default(SearchModeEnum?), string occupancy = default(string), SortEnum? sort = default(SortEnum?), SaleTypeEnum? saleType = default(SaleTypeEnum?), PropertyTitleEnum? propertyTitle = default(PropertyTitleEnum?), DomainPublicAdapterWebApiModelsV1ListingsCommercialParkingSearch parking = default(DomainPublicAdapterWebApiModelsV1ListingsCommercialParkingSearch), List<ExclusionTypesEnum> exclusionTypes = default(List<ExclusionTypesEnum>), int annualReturn = default(int))
        {
            ...
            this.BuildingSizeMin = buildingSizeMin;
            this.BuildingSizeMax = buildingSizeMax;
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialPriceSearch Price { get; set; }
        ...
        public List<DomainPublicAdapterWebApiModelsV1ListingsCommercialLocationSearch> Locations { get; set; }
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialGeoWindow GeoWindow { get; set; }

        /// <summary>
        /// Minimum land area
        /// </summary>
        /// <value>Minimum land area</value>
        [DataMember(Name = "landAreaMin", EmitDefaultValue = false)]
        public int LandAreaMin { get; set; }

        /// <summary>
        /// Maximum land area
        /// </summary>
        /// <value>Maximum land area</value>
        [DataMember(Name = "landAreaMax", EmitDefaultValue = false)]
        public int LandAreaMax { get; set; }

        /// <summary>
        /// Minimum building area
        /// </summary>
        /// <value>Minimum building area</value>
        [DataMember(Name = "buildingSizeMin", EmitDefaultValue = false)]
        public int BuildingSizeMin { get; set; }

        /// <summary>
        /// Maximum building area
        /// </summary>
        /// <value>Maximum building area</value>
        [DataMember(Name = "buildingSizeMax", EmitDefaultValue = false)]
        public int BuildingSizeMax { get; set; }
        ...
        public DomainPublicAdapterWebApiModelsV1ListingsCommercialParkingSearch Parking { get; set; }

        /// <summary>
        /// Minimum annual return (in percents)
        /// </summary>
        /// <value>Minimum annual return (in percents)</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest {\n");
            ...
            sb.Append("  LandAreaMin: ").Append(LandAreaMin).Append("\n");
            sb.Append("  LandAreaMax: ").Append(LandAreaMax).Append("\n");
            sb.Append("  BuildingSizeMin: ").Append(BuildingSizeMin).Append("\n");
            sb.Append("  BuildingSizeMax: ").Append(BuildingSizeMax).Append("\n");
            ...
            sb.Append("  PropertyTitle: ").Append(PropertyTitle).Append("\n");
            sb.Append("  Parking: ").Append(Parking).Append("\n");
            sb.Append("  ExclusionTypes: ").Append(ExclusionTypes).Append("\n");
        ...
        {
            return this.Equals(input as DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest);
        }

        /// <summary>
        /// Returns true if DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DomainPublicAdapterWebApiModelsV1ListingsCommercialSearchRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.LandAreaMin == input.LandAreaMin ||
                    this.LandAreaMin.Equals(input.LandAreaMin)
                ) && 
                (
                    this.LandAreaMax == input.LandAreaMax ||
                    this.LandAreaMax.Equals(input.LandAreaMax)
                ) && 
                (
                    this.BuildingSizeMin == input.BuildingSizeMin ||
                    this.BuildingSizeMin.Equals(input.BuildingSizeMin)
                ) && 
                (
                    this.BuildingSizeMax == input.BuildingSizeMax ||
                    this.BuildingSizeMax.Equals(input.BuildingSizeMax)
                ) && 
                (
                ...
                (
                    this.PropertyTitle == input.PropertyTitle ||
                    this.PropertyTitle.Equals(input.PropertyTitle)
                ) && 
                (
                ...
                (
                    this.ExclusionTypes == input.ExclusionTypes ||
                    this.ExclusionTypes.SequenceEqual(input.ExclusionTypes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.LandAreaMin.GetHashCode();
                hashCode = hashCode * 59 + this.LandAreaMax.GetHashCode();
                hashCode = hashCode * 59 + this.BuildingSizeMin.GetHashCode();
                hashCode = hashCode * 59 + this.BuildingSizeMax.GetHashCode();
                ...
                hashCode = hashCode * 59 + this.PropertyTitle.GetHashCode();
                if (this.Parking != null)
                    hashCode = hashCode * 59 + this.Parking.GetHashCode();
                hashCode = hashCode * 59 + this.ExclusionTypes.GetHashCode();
