...
namespace Domain.Api.V2.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListingAdmin.v2.AgentContact")]
    public partial class ListingAdminV2AgentContact : IEquatable<ListingAdminV2AgentContact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingAdminV2AgentContact" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ListingAdminV2AgentContact() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingAdminV2AgentContact" /> class.
        /// </summary>
        /// <param name="agencyId">Conjunction agent&#39;s agency (required).</param>
        ...
        public ListingAdminV2AgentContact(int agencyId = default(int), int domainAgentId = default(int), string firstName = default(string), string lastName = default(string), string phone = default(string), string fax = default(string), string mobile = default(string), string email = default(string), bool receiveEmails = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListingAdminV2AgentContact {\n");
        ...
        {
            return this.Equals(input as ListingAdminV2AgentContact);
        }

        /// <summary>
        /// Returns true if ListingAdminV2AgentContact instances are equal
        /// </summary>
        /// <param name="input">Instance of ListingAdminV2AgentContact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListingAdminV2AgentContact input)
        {
            if (input == null)
                return false;
