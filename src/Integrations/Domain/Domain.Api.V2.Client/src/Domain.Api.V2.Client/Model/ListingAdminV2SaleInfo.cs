...
namespace Domain.Api.V2.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListingAdmin.v2.SaleInfo")]
    public partial class ListingAdminV2SaleInfo : IEquatable<ListingAdminV2SaleInfo>, IValidatableObject
    {
        ...
        protected ListingAdminV2SaleInfo() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingAdminV2SaleInfo" /> class.
        /// </summary>
        ...
        [DataMember(Name = "annualSales", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "annualProfit", IsRequired = true, EmitDefaultValue = false)]
        ...
        [DataMember(Name = "stockValue", IsRequired = true, EmitDefaultValue = false)]
