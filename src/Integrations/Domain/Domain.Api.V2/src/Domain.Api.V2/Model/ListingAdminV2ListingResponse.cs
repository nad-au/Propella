...
namespace Domain.Api.V2.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListingAdmin.v2.ListingResponse")]
    public partial class ListingAdminV2ListingResponse : IEquatable<ListingAdminV2ListingResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingAdminV2ListingResponse" /> class.
        /// </summary>
        ...
        public ListingAdminV2ListingResponse(string id = default(string), int agencyId = default(int), string providerId = default(string), string providerAdId = default(string), string versionId = default(string), ProcessStatusEnum? processStatus = default(ProcessStatusEnum?))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListingAdminV2ListingResponse {\n");
        ...
        {
            return this.Equals(input as ListingAdminV2ListingResponse);
        }

        /// <summary>
        /// Returns true if ListingAdminV2ListingResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ListingAdminV2ListingResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListingAdminV2ListingResponse input)
        {
            if (input == null)
                return false;
