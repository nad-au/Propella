...
namespace Domain.Api.Client.Api
{
    ...
    public partial class SuburbPerformanceStatisticsApi : ISuburbPerformanceStatisticsApi
    {
        ...
        /// <returns></returns>
        public SuburbPerformanceStatisticsApi(Domain.Api.Client.Client.Configuration configuration)
        {
        ...
        public SuburbPerformanceStatisticsApi(Domain.Api.Client.Client.ISynchronousClient client, Domain.Api.Client.Client.IAsynchronousClient asyncClient, Domain.Api.Client.Client.IReadableConfiguration configuration)
        {
        ...
        {
            Domain.Api.Client.Client.ApiResponse<SuburbPerformanceStatisticsV3SuburbPerformance> localVarResponse = SuburbPerformanceGetByNamedSuburbWithHttpInfo(state, suburb, postcode, propertyCategory, bedrooms, periodSize, startingPeriodRelativeToCurrent, totalPeriods);
        ...
        /// <param name="totalPeriods">Number of total periods to show statistics for. i.e. 4 Quarters would be 1 full year (optional, default to 4)</param>
        /// <returns>ApiResponse of SuburbPerformanceStatisticsV3SuburbPerformance</returns>
        public Domain.Api.Client.Client.ApiResponse<SuburbPerformanceStatisticsV3SuburbPerformance> SuburbPerformanceGetByNamedSuburbWithHttpInfo(string state, string suburb, string postcode, SuburbPerformanceStatisticsV3PropertyCategory? propertyCategory = default(SuburbPerformanceStatisticsV3PropertyCategory?), int? bedrooms = default(int?), SuburbPerformanceStatisticsV3PeriodSize? periodSize = default(SuburbPerformanceStatisticsV3PeriodSize?), int? startingPeriodRelativeToCurrent = default(int?), int? totalPeriods = default(int?))
        {
            // verify the required parameter 'state' is set
            if (state == null)
                throw new Domain.Api.Client.Client.ApiException(400, "Missing required parameter 'state' when calling SuburbPerformanceStatisticsApi->SuburbPerformanceGetByNamedSuburb");

            // verify the required parameter 'suburb' is set
            if (suburb == null)
                throw new Domain.Api.Client.Client.ApiException(400, "Missing required parameter 'suburb' when calling SuburbPerformanceStatisticsApi->SuburbPerformanceGetByNamedSuburb");

            // verify the required parameter 'postcode' is set
            if (postcode == null)
                throw new Domain.Api.Client.Client.ApiException(400, "Missing required parameter 'postcode' when calling SuburbPerformanceStatisticsApi->SuburbPerformanceGetByNamedSuburb");
            ...
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "propertyCategory", propertyCategory));
            }
            if (bedrooms != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "bedrooms", bedrooms));
            }
            if (periodSize != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "periodSize", periodSize));
            }
            if (startingPeriodRelativeToCurrent != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "startingPeriodRelativeToCurrent", startingPeriodRelativeToCurrent));
            }
            if (totalPeriods != null)
            {
                localVarRequestOptions.QueryParameters.Add(Domain.Api.Client.Client.ClientUtils.ParameterToMultiMap("", "totalPeriods", totalPeriods));
            }
        ...
        {
            Domain.Api.Client.Client.ApiResponse<SuburbPerformanceStatisticsV3SuburbPerformance> localVarResponse = await SuburbPerformanceGetByNamedSuburbWithHttpInfoAsync(state, suburb, postcode, propertyCategory, bedrooms, periodSize, startingPeriodRelativeToCurrent, totalPeriods, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (SuburbPerformanceStatisticsV3SuburbPerformance)</returns>
        public async System.Threading.Tasks.Task<Domain.Api.Client.Client.ApiResponse<SuburbPerformanceStatisticsV3SuburbPerformance>> SuburbPerformanceGetByNamedSuburbWithHttpInfoAsync(string state, string suburb, string postcode, SuburbPerformanceStatisticsV3PropertyCategory? propertyCategory = default(SuburbPerformanceStatisticsV3PropertyCategory?), int? bedrooms = default(int?), SuburbPerformanceStatisticsV3PeriodSize? periodSize = default(SuburbPerformanceStatisticsV3PeriodSize?), int? startingPeriodRelativeToCurrent = default(int?), int? totalPeriods = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'state' is set
            if (state == null)
                throw new Domain.Api.Client.Client.ApiException(400, "Missing required parameter 'state' when calling SuburbPerformanceStatisticsApi->SuburbPerformanceGetByNamedSuburb");
