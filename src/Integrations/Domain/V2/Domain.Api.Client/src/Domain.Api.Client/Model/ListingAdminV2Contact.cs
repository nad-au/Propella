...
namespace Domain.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ListingAdmin.v2.Contact")]
    public partial class ListingAdminV2Contact : IEquatable<ListingAdminV2Contact>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListingAdminV2Contact" /> class.
        /// </summary>
        ...
        public ListingAdminV2Contact(int domainAgentId = default(int), string firstName = default(string), string lastName = default(string), string phone = default(string), string fax = default(string), string mobile = default(string), string email = default(string), bool receiveEmails = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListingAdminV2Contact {\n");
        ...
        {
            return this.Equals(input as ListingAdminV2Contact);
        }

        /// <summary>
        /// Returns true if ListingAdminV2Contact instances are equal
        /// </summary>
        /// <param name="input">Instance of ListingAdminV2Contact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListingAdminV2Contact input)
        {
            if (input == null)
                return false;
