...
namespace Domain.Api.Client.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PreMarket.v1.ProblemDetails")]
    public partial class PreMarketV1ProblemDetails : Dictionary<String, Object>, IEquatable<PreMarketV1ProblemDetails>, IValidatableObject
    {
        ...
        public PreMarketV1ProblemDetails(string type = default(string), string title = default(string), int? status = default(int?), string detail = default(string), string instance = default(string)) : base()
        {
            this.Type = type;
            this.Title = title;
            this.Status = status;
